...
export default function Home() {
  ...
  const handleSearch = async (searchText) => { 
    ...
    if (trimmedSearch === "" && !selectedCategory && priceRange === 1000) {
      setProducts([]);
      setCursor(null);
      setHasMore(true);
  ...
  const handleFilterProducts = async () => {
    ...
    try {
      ...
      const response = await filterProductsAPI(selectedCategory, priceRange);
    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8">
        ...
        <div className="space-y-8">
          ...
          {loading && (
            <div className="mt-10 text-center text-xl">Loading Products...</div>
          )}
